...
def main():
    ...
    parser.add_argument('--data', type=str, default='datasets/dataset-1000.csv', help='Path to the synthetic CSV dataset')
    parser.add_argument('--model-out', type=str, default='models/catboost_pipeline.pkl', help='Path to save output model')
    parser.add_argument('--plots-out', type=str, default='docs/ml_assets', help='Path to save evaluation plots')
